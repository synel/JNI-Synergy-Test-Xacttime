...
//	params[1] = 0; //reserved for sensor_INTSUBMSK
//	params[2] = 0; //reserved for sensor_INTMSK
    params[1] = ((1<<0) | (1<<3) | (1<<6));
    params[2] = ((1<<28) | (1<<23) | (1<<15));
	params[3] = 0; //reserved
	params[4] = 0; //reserved
...
// Input    :
//     pImage - fingerprint image to be evaluated, 256*256 dimension.
// Output   :
// Return   :
//质量分数：0-255
//<125 质量特别差
...
//200-255 质量特别好
//     quality score
int SB_FP_GET_QUALITY(IN BYTE *pImage)
{
        engLastError = SB_fp(FP_QUALIFY_FPDATA, (long)pImage, 0, 0, 0, 0);
